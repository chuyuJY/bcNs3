 ...
 * - numerologies: 0, 1
 */
class NrSystemTestSchedulerOfdmaMrSuite : public TestSuite
{
public:
  /**
   * \brief constructor
...
NrSystemTestSchedulerOfdmaMrSuite::NrSystemTestSchedulerOfdmaMrSuite ()
  : TestSuite ("nr-system-test-schedulers-ofdma-mr", SYSTEM)
{
  enum TxMode
  {
    DL,
...
static NrSystemTestSchedulerOfdmaMrSuite mmwaveTestSuite;
