 ...
 * - numerologies: 0, 1
 */
class NrSystemTestSchedulerTdmaPfSuite : public TestSuite
{
public:
  /**
   * \brief constructor
   */
  NrSystemTestSchedulerTdmaPfSuite ();
};

NrSystemTestSchedulerTdmaPfSuite::NrSystemTestSchedulerTdmaPfSuite ()
: TestSuite ("nr-system-test-schedulers-tdma-pf", SYSTEM)
{
  enum TxMode
  {
    DL,
...
static NrSystemTestSchedulerTdmaPfSuite mmwaveTestSuite;
