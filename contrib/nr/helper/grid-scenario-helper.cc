...
GridScenarioHelper::CreateScenario ()
{
  ...
  mobilityUE.SetPositionAllocator (utPos);
  mobilityUE.SetMobilityModel ("ns3::RandomWalk2dMobilityModel", "Mode", StringValue ("Time"),
                               "Time", StringValue ("2s"), "Speed",
                               StringValue ("ns3::ConstantRandomVariable[Constant=1.0]"), "Bounds",
                               StringValue ("-200|200|-200|200"));
  //"-60|60|-60|60"
  //"-50|100|-30|20"  场景
  mobilityUE.Install (m_ut);
}
